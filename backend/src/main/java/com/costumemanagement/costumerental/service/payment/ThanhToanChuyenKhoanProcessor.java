...
@Component
public class ThanhToanChuyenKhoanProcessor implements ThanhToanProcessor {

    private static final Logger logger = LoggerFactory.getLogger(ThanhToanChuyenKhoanProcessor.class);

    @Override
    public boolean pay(HoaDonNhap hoaDon) {
        logger.info("Xu ly thanh toan CHUYEN KHOAN - Hoa don: {} - So tien: {}",
    ...
    public PaymentMethod getPaymentMethod() {
        return PaymentMethod.CHUYEN_KHOAN;
    }
}
